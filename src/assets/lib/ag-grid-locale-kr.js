...
const AG_GRID_LOCALE_KR = {
    ...
    filterSummaryStartsWith: '시작됨',
    filterSummaryEndsWith: '끝남',
    ...
    // Formulas
    invalidFormulaValidation: '유효하지 않은 수식입니다.',
    formulaParseInvalidCellReference: '유효하지 않은 셀 참조: ${variable}.',
    formulaParseInvalidRangeEndReference: '범위 끝 참조가 유효하지 않습니다.',
    formulaParseUnterminatedString: '문자열이 종료되지 않았습니다.',
    formulaParseUnexpectedCharacter: '예상치 못한 문자: ${variable}.',
    formulaParseOperatorStackUnderflow: '연산자 스택 언더플로우.',
    formulaParseMissingOperand: "'${variable}'에 대한 피연산자가 없습니다.",
    formulaParseInternalUnexpectedFrameDuringReduction: '내부 오류: 축약 중 예상치 못한 프레임이 발견되었습니다.',
    formulaParseInternalUnexpectedFrameBeforeOpenParen: "내부 오류: '(' 앞에 예상치 못한 프레임이 있습니다.",
    formulaParseMisplacedComma: '쉼표 위치가 잘못되었습니다.',
    formulaParseCommaOutsideFunctionCall: '함수 호출 밖에 쉼표가 있습니다.',
    formulaParseInternalUnexpectedFrameBeforeCloseParen: "내부 오류: ')' 앞에 예상치 못한 프레임이 있습니다.",
    formulaParseMismatchedParentheses: '괄호가 일치하지 않습니다.',
    formulaParseUnsupportedOperand: '지원되지 않는 피연산자: ${variable}.',
    formulaParseMismatchedParenthesesOrUnfinishedFunctionCall: '괄호 불일치 또는 함수 호출이 완료되지 않았습니다.',
    formulaParseInvalidExpression: '잘못된 수식입니다.',
    formulaParseFormulasMustBeginWithEquals: '수식은 = 로 시작해야 합니다.',
    formulaSerializeStringContainsQuote: '문자열에 tokenizer가 지원하지 않는 따옴표 (")가 포함되어 있습니다.',
    formulaSerializeCannotProduceAbsoluteColumnLabelFromId: "ID '${variable}'에서 절대 열 라벨을 생성할 수 없습니다.",
    formulaSerializeCannotProduceAbsoluteRowIndexFromId: "ID '${variable}'에서 절대 행 인덱스를 생성할 수 없습니다.",
    formulaSerializeCannotProduceRowIndexFromId: "ID '${variable}'에서 행 인덱스를 생성할 수 없습니다.",
    formulaSerializeCannotMapColumnIdToA1Label: "열 ID '${variable}'를 A1 라벨로 매핑할 수 없습니다.",
    formulaSerializeCannotParseAbsoluteRowIndex: "절대 행 인덱스 '${variable}'를 파싱할 수 없습니다.",
    formulaSerializeCannotMapRowIdToA1Index: "행 ID '${variable}'를 A1 인덱스로 매핑할 수 없습니다.",
    formulaEvalRangeNotAllowedInScalarContext: '스칼라 컨텍스트에서는 범위를 사용할 수 없습니다.',
    formulaEvalUnknownReferenceToCell: '알 수 없는 셀 참조입니다.',
    formulaEvalUnsupportedOperation: '지원되지 않는 연산 ${variable}.',
    formulaEvalInvalidAbsoluteRow: '유효하지 않은 절대 행입니다.',
    formulaEvalUnrecognisedRowId: '인식할 수 없는 행 ID입니다.',
    formulaEvalInvalidAbsoluteColumn: '유효하지 않은 절대 열입니다.',
    formulaEvalUnrecognisedColumnId: '인식할 수 없는 열 ID입니다.',
    formulaEvalUnrecognisedRowInRange: '범위 내 인식할 수 없는 행이 있습니다.',
    formulaEvalUnrecognisedReferenceToCell: '인식할 수 없는 셀 참조입니다.',
    formulaEvalIncompleteRangeReference: '불완전한 범위 참조입니다.',
    formulaFunctionExpectedExactlyArguments: '${variable}: 인수는 정확히 ${variable}개여야 합니다.',
    formulaFunctionExpectedAtMostArguments: '${variable}: 인수는 최대 ${variable}개여야 합니다.',
    formulaFunctionExpectedAtLeastArguments: '${variable}: 인수는 최소 ${variable}개여야 합니다.',
    formulaFunctionInvalidCriteriaWildcardsWithComparator:
        '잘못된 조건: 비교 연산자와 와일드카드를 함께 사용할 수 없습니다.',
    formulaFunctionNonNumericArgument: '${variable}: 숫자가 아닌 인수입니다.',
    formulaFunctionDivisionByZero: '${variable}: 0으로 나눌 수 없습니다.',
    formulaFunctionCannotCombineDatesWithBigInt: '${variable}: 날짜와 BigInt를 함께 사용할 수 없습니다.',
    formulaFunctionRequiresAtLeastOneNumericValue: '${variable}: 최소 하나의 숫자 값이 필요합니다.',
    formulaFunctionRequiresAtLeastOneValue: '${variable}: 최소 하나의 값이 필요합니다.',
    formulaFunctionAllValuesMustBeNumbers: '${variable}: 모든 값은 숫자여야 합니다.',
    formulaFunctionArgumentMustBeRange: '${variable}: ${variable}번째 인수는 범위여야 합니다.',
    formulaFunctionArgumentMustBeValue: '${variable}: ${variable}번째 인수는 값이어야 합니다.',
    formulaFunctionRangesHaveDifferentSizes: '${variable}: 범위의 크기가 다릅니다.',
    formulaFunctionValuesMustBeNumeric: '${variable}: 값은 숫자여야 합니다.',
    formulaFunctionValuesMustBeIntegers: '${variable}: 값은 정수여야 합니다.',
    formulaFunctionUnsupportedValueType: '${variable}: 지원되지 않는 값 유형입니다.',
    formulaFunctionDivNonNumericArgument: 'DIV: 숫자가 아닌 인수입니다.',
    formulaFunctionDivDivisionByZero: 'DIV: 0으로 나눌 수 없습니다.',
    formulaFunctionSumCannotCombineDatesWithBigInt: 'SUM: 날짜와 BigInt를 함께 사용할 수 없습니다.',
    formulaFunctionSumRequiresAtLeastOneNumericValue: 'SUM: 최소 하나의 숫자 값이 필요합니다.',
    formulaFunctionAvgRequiresAtLeastOneValue: 'AVG: 최소 하나의 값이 필요합니다.',
    formulaFunctionMedianAllValuesMustBeNumbers: 'MEDIAN: 모든 값은 숫자여야 합니다.',
    formulaFunctionMedianRequiresAtLeastOneValue: 'MEDIAN: 최소 하나의 값이 필요합니다.',
    formulaFunctionSumifFirstArgumentMustBeRange: 'SUMIF: 첫 번째 인수는 범위여야 합니다.',
    formulaFunctionSumifSecondArgumentMustBeValue: 'SUMIF: 두 번째 인수는 값이어야 합니다 (criteria).',
    formulaFunctionSumifThirdArgumentMustBeRange: 'SUMIF: 세 번째 인수는 범위여야 합니다 (sum_range).',
    formulaFunctionSumifRangesHaveDifferentSizes: 'SUMIF: 범위의 크기가 다릅니다.',
    formulaFunctionCountifFirstArgumentMustBeRange: 'COUNTIF: 첫 번째 인수는 범위여야 합니다.',
    formulaFunctionCountifSecondArgumentMustBeValue: 'COUNTIF: 두 번째 인수는 값이어야 합니다 (criteria).',
    formulaFunctionConcatUnsupportedValueType: 'CONCAT: 지원되지 않는 값 유형입니다.',
    formulaFunctionMinRequiresAtLeastOneValue: 'MIN: 최소 하나의 값이 필요합니다.',
    formulaFunctionMaxRequiresAtLeastOneValue: 'MAX: 최소 하나의 값이 필요합니다.',
    formulaFunctionPercentNonNumericArgument: 'PERCENT: 숫자가 아닌 인수입니다.',
    formulaFunctionPowerNonNumericArgument: 'POWER: 숫자가 아닌 인수입니다.',
    formulaServiceCircularReference: '순환 참조입니다.',
    formulaServiceExpectedParsableFormula: '파싱 가능한 수식이 필요합니다.',
    formulaServiceInternalSchedulingError: '내부 스케줄링 오류.',
    ...
    exportingOoo: '내보내는 중...',
    fileInputOverlay: '파일을 끌어다 놓아 데이터 가져오기',
    ...
    noAggregation: '없음',
    showValuesAs: '값 표시 형식',
    showValuesAsNone: '없음',
    percentOfGrandTotal: '총합계의 백분율',
    percentOfColumnTotal: '열 합계의 백분율',
    percentOfRowTotal: '행 합계의 백분율',
    percentOfParentRowTotal: '상위 행 합계의 백분율',
    percentOfParentColumnTotal: '상위 열 합계의 백분율',
    percentOfGrandTotalDescription: '각 값을 해당 열의 총합계에 대한 백분율로 표시합니다.',
    percentOfColumnTotalDescription: '각 값을 해당 열 합계에 대한 백분율로 표시합니다——각 열의 합계는 100%입니다.',
    percentOfRowTotalDescription: '각 값을 피벗 열 전체의 행 합계에 대한 백분율로 표시합니다.',
    percentOfParentRowTotalDescription: '각 값을 상위 그룹에 대한 백분율로 표시합니다.',
    percentOfParentColumnTotalDescription: '각 값을 상위 피벗 열에 대한 백분율로 표시합니다.',
    autosizeThisColumn: '이 열 자동 크기 조정',
    autosizeAllColumns: '모든 열 자동 크기 조정',
    groupBy: '${variable}별 그룹화',
    ungroupBy: '${variable}별 그룹 해제',
    ungroupAll: '모든 그룹 해제',
    ...
    funnelGroup: '깔때기',
    funnelTooltip: '깔때기',
    coneFunnelTooltip: '원뿔 깔때기',
    pyramidTooltip: '피라미드',
    dropOff: '이탈',
    stageLabels: '단계 레이블',
    reverse: '역방향',
    tooltipMode: '도구 설명 모드',
    tooltipModeSingle: '단일',
    tooltipModeShared: '다중',
    tooltipModeCompact: '컴팩트',
    ...
    ariaSparklineChartDescriptionSingleValue: '스파크라인 - ${chartType}, 값 1개(${value})를 표시합니다.',
